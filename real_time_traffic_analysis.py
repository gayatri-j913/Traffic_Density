...
text_position_left_lane = (3, 50)
text_position_right_lane = (820, 50)
intensity_position_left_lane = (3, 100)
...
while cap.isOpened():
    ...
    if ret:
        ...
        # Add a background rectangle and text for the left lane vehicle count
        cv2.rectangle(processed_frame, (text_position_left_lane[0]-10, text_position_left_lane[1] - 25), 
                      (text_position_left_lane[0] + 460, text_position_left_lane[1] + 10), background_color, -1)
        cv2.putText(processed_frame, f'Vehicles in Left Lane: {vehicles_in_left_lane}', text_position_left_lane, 
                    font, font_scale, font_color, 2, cv2.LINE_AA)

        # Add a background rectangle and text for the left lane traffic intensity
        ...
        # Add a background rectangle and text for the right lane vehicle count
        ...
        # Add a background rectangle and text for the right lane traffic intensity
